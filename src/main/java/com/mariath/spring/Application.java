...
import com.mariath.spring.domain.PagamentoComCartao;
...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 = new Categoria(null, "Otica");
		Categoria cat5 = new Categoria(null, "Farmacia");
		Categoria cat6 = new Categoria(null, "Para ti");
		Categoria cat7 = new Categoria(null, "Para mim");
